...
def main(argv):
  ...
  # (!)
  fake_heap_address0 = 0x10101010
  pointer_to_malloc_memory_address0 = 0x0A2D975C
  initial_state.memory.store(pointer_to_malloc_memory_address0, fake_heap_address0, endness=project.arch.memory_endness, size=project.arch.bits)

  fake_heap_address1 = 0x20202020
  pointer_to_malloc_memory_address1 = 0x0A2D9764
  initial_state.memory.store(pointer_to_malloc_memory_address1, fake_heap_address1, endness=project.arch.memory_endness, size=project.arch.bits)
